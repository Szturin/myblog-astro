...
![](/posts/57564/image-20240916160733688.png)
...
![](/posts/57564/image-20240916163416339.png)

-   使用`array_at(&a,0)`取地址
-   使用`*array_at(&a,0)=10;`可以直接进行赋值操作

当然，也可以重新编写array\_set，array\_get两个函数，分别用于赋值和取值
...
![](/posts/57564/image-20240916164843040.png)

一直循环下去，总会出现数组越界的情况。

于是，继续修改array\_at

![](/posts/57564/image-20240916165102244.png)

引入block概念

![](/posts/57564/image-20240916165338660.png)

# [](#二-可变数组的缺陷)二、 可变数组的缺陷

-   拷贝时间开销大
-   在内存受限的情况下，可能难以申请到更大的内存空间
-   ![](/posts/57564/image-20240916165754291.png)

解决方案：  
不去修改原来的内存空间，链接1个block即可拓展数组长度

![](/posts/57564/image-20240916165911534.png)
...
![](/posts/57564/image-20240916170101356.png)
```c
...
![](/posts/57564/image-20240916170714369.png)
...
```
![](/posts/57564/image-20240916173028618.png)
...
```
![](/posts/57564/image-20240916194131704.png)
...
![](/posts/57564/image-20240916202900021.png)
